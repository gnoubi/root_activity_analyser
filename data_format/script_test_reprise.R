...
myQuery1 <- paste0("SELECT id_suj, ref_site  FROM db_arbre.SUJET where type_strate = 'arbre' ")
...
for (s  in 1:443)  {
      ...
      structured_dataDateS1 <- within(activity_sequence1, {date_structStar <- as.Date(as.POSIXct( activity_sequence1$start, origin = "1970-01-01"))
      })
      ...
      structured_dataDateS2 <- within(activity_sequence2, {date_structStar <- as.Date(as.POSIXct( activity_sequence2$start, origin = "1970-01-01"))
      })
      ...
      structured_dataDateS3 <- within(activity_sequence3, {date_structStar <- as.Date(as.POSIXct( activity_sequence3$start, origin = "1970-01-01"))
      })
      ...
      #ajout des dates de premieres activités
